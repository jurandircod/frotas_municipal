                        ...
                        <td class="px-3 py-3">
                            <div class="flex gap-2">
                                <button type="button"
                                    ...
                                    data-id="{{ $c->id }}"
                                    data-nome-veiculo="{{ $c->nome_veiculo }}"
                                    data-placa="{{ $c->placa }}"
                                    data-numero-cartao="{{ $c->numero_cartao }}"
    ...
    <div class="bg-white rounded-xl w-full max-w-lg p-6 shadow-lg">
        ...
        <form id="formEditCartao" method="POST">
            ...
            <div class="space-y-3">
                <div>
                    <label class="text-sm text-gray-600">Nome do veículo</label>
                    <input type="text" name="nome_veiculo" id="edit_nome_veiculo"
                        class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>

                <div>
                    <label class="text-sm text-gray-600">Placa</label>
                    <input type="text" name="placa" id="edit_placa"
                        class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>

                <div>
                    <label class="text-sm text-gray-600">Número do cartão</label>
                    <input type="text" name="numero_cartao" id="edit_numero_cartao"
                        class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
...
<script>
    ...
    document.querySelectorAll('.btn-open-edit').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('edit_aumento_horimetro').value = this.dataset.aumentoHorimetro ?? 0;
