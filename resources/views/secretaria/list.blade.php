                                ...
                                <td class="py-4 px-3">
                                    <div class="flex gap-2">
                                        <button
                                            ...
                                            data-update-route="{{ route('secretaria.edit', $secretaria->id) }}"
                                        >
                                            Alterar
                                        </button>
...
<div id="editSecretariaModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="border-b border-gray-100 px-6 py-4 bg-gradient-to-r from-blue-50 to-white flex items-center justify-between">
            <div>
